...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "G_MEM_SIZE_MAX_N" -parent ${Page_0}
  ipgui::add_param $IPINST -name "G_PWM_N" -parent ${Page_0}
  ipgui::add_param $IPINST -name "G_RST_POL" -parent ${Page_0}
  ipgui::add_param $IPINST -name "G_STATE_MAX_N" -parent ${Page_0}
...
proc update_PARAM_VALUE.G_PERIOD_MAX_L2 { PARAM_VALUE.G_PERIOD_MAX_L2 PARAM_VALUE.G_PERIOD_MAX_N } {
	...
	set G_PERIOD_MAX_N ${PARAM_VALUE.G_PERIOD_MAX_N}
	set values(G_PERIOD_MAX_N) [get_property value $G_PERIOD_MAX_N]
	set_property value [gen_USERPARAMETER_G_PERIOD_MAX_L2_VALUE $values(G_PERIOD_MAX_N)] $G_PERIOD_MAX_L2
}
...
proc update_PARAM_VALUE.G_PERIOD_MAX_N { PARAM_VALUE.G_PERIOD_MAX_N PARAM_VALUE.G_STATE_MAX_N PARAM_VALUE.G_MEM_SIZE_MAX_N } {
	# Procedure called to update G_PERIOD_MAX_N when any of the dependent parameters in the arguments change
	
	set G_PERIOD_MAX_N ${PARAM_VALUE.G_PERIOD_MAX_N}
	set G_STATE_MAX_N ${PARAM_VALUE.G_STATE_MAX_N}
	set G_MEM_SIZE_MAX_N ${PARAM_VALUE.G_MEM_SIZE_MAX_N}
	set values(G_STATE_MAX_N) [get_property value $G_STATE_MAX_N]
	set values(G_MEM_SIZE_MAX_N) [get_property value $G_MEM_SIZE_MAX_N]
	set_property value [gen_USERPARAMETER_G_PERIOD_MAX_N_VALUE $values(G_STATE_MAX_N) $values(G_MEM_SIZE_MAX_N)] $G_PERIOD_MAX_N
}

proc validate_PARAM_VALUE.G_PERIOD_MAX_N { PARAM_VALUE.G_PERIOD_MAX_N } {
	# Procedure called to validate G_PERIOD_MAX_N
	return true
}

proc update_PARAM_VALUE.G_STATE_MAX_L2 { PARAM_VALUE.G_STATE_MAX_L2 PARAM_VALUE.G_STATE_MAX_N } {
	...
	set G_STATE_MAX_N ${PARAM_VALUE.G_STATE_MAX_N}
	set values(G_STATE_MAX_N) [get_property value $G_STATE_MAX_N]
	set_property value [gen_USERPARAMETER_G_STATE_MAX_L2_VALUE $values(G_STATE_MAX_N)] $G_STATE_MAX_L2
}
...
proc update_PARAM_VALUE.G_STATE_MAX_N { PARAM_VALUE.G_STATE_MAX_N } {
	# Procedure called to update G_STATE_MAX_N when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.G_STATE_MAX_N { PARAM_VALUE.G_STATE_MAX_N } {
	# Procedure called to validate G_STATE_MAX_N
	return true
}
...
proc update_MODELPARAM_VALUE.G_STATE_MAX_N { MODELPARAM_VALUE.G_STATE_MAX_N PARAM_VALUE.G_STATE_MAX_N } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.G_STATE_MAX_N}] ${MODELPARAM_VALUE.G_STATE_MAX_N}
}
...
proc update_MODELPARAM_VALUE.G_PERIOD_MAX_N { MODELPARAM_VALUE.G_PERIOD_MAX_N PARAM_VALUE.G_PERIOD_MAX_N } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.G_PERIOD_MAX_N}] ${MODELPARAM_VALUE.G_PERIOD_MAX_N}
}
