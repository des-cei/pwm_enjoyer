...
\
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn  [get_bd_pins rst_ps7_0_125M/peripheral_aresetn] \
  [get_bd_pins aresetn] \
...
proc create_hier_cell_RGB_LEDS { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 2 -to 0 CTRL_I
  ...
  # Create port connections
  connect_bd_net -net MODE_I_0_1  [get_bd_pins CTRL_I] \
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins PS/M00_AXI] [get_bd_intf_pins PWM_ENJOYER/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net PWM_ENJOYER_STATUS_O  [get_bd_pins PWM_ENJOYER/STATUS_O] \
  [get_bd_pins RGB_LEDS/CTRL_I]
  connect_bd_net -net processing_system7_0_FCLK_CLK1  [get_bd_pins PS/FCLK_CLK0] \
  ...
  [get_bd_ports PWMS]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn  [get_bd_pins PS/aresetn] \
